...
/
Focus search box
Attributes overview &raquo;
&laquo; Comparing generators with Iterator objects        
...
Other
# Attributes
## Table of Contents- [Attributes overview](language.attributes.overview.php)- [Attribute syntax](language.attributes.syntax.php)- [Reading Attributes with the Reflection API](language.attributes.reflection.php)- [Declaring Attribute Classes](language.attributes.classes.php)
### Found A Problem?
...
[＋add a note](/manual/add-note.php?sect=language.attributes&repo=en&redirect=https://www.php.net/manual/en/language.attributes.php)
